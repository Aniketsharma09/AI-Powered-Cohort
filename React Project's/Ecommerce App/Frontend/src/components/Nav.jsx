...
const Nav = () => {
  ...
  return (
    <nav className="w-full  text-[var(--nav-t)] flex p-2">
      ...
      <div className="w-[75%]  flex items-center justify-center gap-[3rem] h-14 text-xl tracking-wider">
        <NavLink
          className={({ isActive }) =>
            isActive
        ...
        <div className="w-[30%] relative ml-10 ">
          <input
      ...
      <div className="flex items-center justify-center w-[10%] ">
        {user?.length == 0 ? (
          <button
            ...
            className="hover:scale-98 active:scale-97 px-3 py-2 bg-[var(--btn)] rounded-md tracking-wider w-fit text-xl flex items-center justify-center"
          >
            Login
          </button>
        ) : (
          <>
            <button
              ...
              className="w-12 h-12 bg-red-400 rounded-full ml-15 hover:scale-103 active:scale-100 overflow-hidden"
            >
              <img
