...
const UserProfile = () => {
  ...
  return (
    <div className="w-full h-fit">
      <h1 className="text-4xl text-[var(--text-h)] text-center mt-10 font-bold tracking-widest">
        Personal Information
      </h1>
      <div className="w-full h-full flex">
        <div className="w-[40%] h-fit flex flex-col items-center gap-6 ">
        ...
        <form
          ...
          className=" w-[60%] p-10 flex gap-10 flex-col mt-5"
        >
          ...
          <div className="w-full flex items-center justify-between">
            <button className="hover:scale-99 w-[48%] bg-[var(--btn)] p-3 flex iteam-center  justify-center rounded-md text-xl active:scale-98 text-[var(--btn-t)] tracking-wide mt-4 cursor-pointer">
              Update Profile
            </button>
            <button onClick={deleteUserHandler} className="hover:scale-99 w-[48%] bg-red-400 p-3 flex iteam-center  justify-center rounded-md text-xl active:scale-98 text-[var(--btn-t)] tracking-wide mt-4 cursor-pointer">
      ...
      <div className="h-[12vh] w-full flex items-center  px-10 justify-between  p-3">
        <h1 className="text-4xl font-bold text-[var(--text-h)] ml-30 ">Theme</h1>
        <h1 className="text-4xl font-bold text-[var(--text-h)] ml-30 ">:</h1>
