...
const AboutUs = () => {
  ...
  return (
    <div className="w-full h-fit ">
      <div className="w-full h-[80vh] flex items-center justify-center flex-col gap-6 relative ">
      ...
      <div className="bg-[var(--nav)] h-[90vh] w-full p-5 flex items-center justify-center ">
        <div className="w-[43%] h-full flex items-center justify-center flex-col gap-5">
        ...
        <div className="w-[57%] h-[80%] gap-6 p-5 flex flex-wrap text-center justify-center ">
